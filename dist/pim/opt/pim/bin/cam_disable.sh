...
#sleep 3
logger -s -p local0.notice "[RST][$tag:$LINENO] rmmod imx8-media-dev, max9296"
...
#logger -s -p local0.notice "[RST][$tag:$LINENO] cam disabled"
#sleep 1
#logger -p local0.notice "[RST][$tag:$LINENO] modprobe imx8-media-dev, max9296"
modprobe max9296
#sleep 1
modprobe imx8-media-dev
logger -s p local0.emerg "[RST][$tag:$LINENO] modprobe imx8-media-dev, max9296"
sleep 1
